// Page À Propos pour ALMAS & MIDAS
...
const AboutPage = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Artisan joaillier formé aux techniques classiques européennes.',
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6">
            L'Excellence <span className="text-gradient-gold"> EUROPEENNES </span>
            <br />en Joaillerie
          </h1>
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Depuis 1999, ALMAS & MIDAS perpétue l'art ancestral de la joaillerie 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground">
              <p>
              Tout a commencé en 1999, dans les allées d’un vieux marché artisanal, où Almas et Dimas ont découvert leur passion commune pour l’art de la joaillerie. Nourris par un savoir-faire ancestral et formés aux standards internationaux, ils ont fondé ALMAS & MIDAS avec une vision claire : créer des bijoux d’exception qui portent en eux une histoire.


              </p>
              <p>
                Aujourd'hui, notre atelier combine le savoir-faire avec 
              ...
              <p>
                ...
                dans la joaillerie de luxe en européennes et à l'international, tout en préservant 
